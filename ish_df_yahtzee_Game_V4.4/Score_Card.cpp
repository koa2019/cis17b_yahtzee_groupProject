...
void ScoreCard::setFinalSC(ScoreCard &scorecard, int diceArr[], bool clearance){
    ...
    // Set category in final scoreboard
    ...
    cout<<"\n\tActual ";
    printScoreCard();
    cout << setw(26) << "Total Score: " << setw(3) << getTotalScore() << "\n";
}
...
void ScoreCard::fillScoreCard(int diceArr[], bool clearance) {
    ...
    //  CHECK Lower section of scorecard
    ...
    // If 3 or 4 of kind is true, then set scorecard
    ...
    // if small or large straight, then set temp scorecard
