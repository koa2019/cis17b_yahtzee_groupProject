...
//************************************************************
//void ScoreCard::fillScoreCard(Dice diceArr[]) {
...
void ScoreCard::printFinalSC(string name){    
    ...
    int upSum = 0, bonus = 25, bonusMin = 20;    
    getUpLowSums();
    upSum = ( round==13 && upperScore >= bonusMin ) ? (upperScore+bonus) : upperScore;
    ...
    cout << setw(5) << " "  << left << setw(20) << "| Bonus"       << " | " << right << setw(6) << ( (round==13 && upperScore >= bonusMin) ? bonus : 0 ) << " |\n";
    cout << setw(5) << " "  << "-------------------------------\n";
