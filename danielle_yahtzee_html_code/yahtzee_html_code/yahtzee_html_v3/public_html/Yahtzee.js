...
Yahtzee.prototype.startGame = function (user) {
    ...
    console.log("<br/>Hit startGame()<br/>");
    ...
    if (this.nPlayer > 1) {
        document.write("<br/>" + name[0] + " vs " + name[1] + "<br/>");
    }
    this.pause();
    ...
    for (var rnd = 1; rnd <= MAXRND; rnd++) {
        ...
        document.write("<br/><br/>Round " + finalSC[0].getRound() + "<br/><br/>");
    ...
    document.write("<br/>Outside of rounds loop<br/>");
    ...
    document.write("End of startGame()<br/>");
};
...
Yahtzee.prototype.play = function (player, scorecard, finalSC, pIndx) {
    ...
    while (!(numRolls === MAXROLLS)) {
        ...
        document.write("<br/>   " + name + "s turn. Round " + rnd + " Roll " + (numRolls + 1) + "<br/>");
...
Yahtzee.prototype.getNPlayer = function () {
    ...
    var num = 1;
    //do {
    document.write("<br/><br/>How many players?\nEnter number between 1 and 2: <br/>");
    //cin >> num;
    num = MINSIZE;
    //} while(!(num >= 1 && num <= MINSIZE));
