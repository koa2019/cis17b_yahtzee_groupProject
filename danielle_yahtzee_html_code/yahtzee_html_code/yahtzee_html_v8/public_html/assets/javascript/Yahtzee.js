...
function Yahtzee(user) {
    ...
    this.userCurrentHiScore = currentPlayerData.hiScore;
    ...
    this.player[this.index].setUser2(1, currentPlayerData.Name);// Reset player 1's name with user's name  
...
Yahtzee.prototype.isNewHiScore = function () {
    ...
    if (this.player[0].getHiScore() > this.userCurrentHiScore) {
        ...
        // this.player[0].getId(), this.player[0].getName(); this.player[0].getHiScore() 
