...
void ScoreCard::getUpLowSums() {
    ...
    for (int i = 0; i < 6; i++) {  
        ...
        if(i == 5){ 
            upScore = total; 
            //cout<<"\n\tHit i==5. upScore="<<upScore<<" total="<<total <<endl;
        } 
    }
    ...
    total = 0;
     for (int i = 6; i < 13; i++) {  
      ...
      //cout<<"\nupScore = " << upScore << "  lowSum = " << lowSum << endl;
}
...
void ScoreCard::fillScoreCard(int diceArr[]) {
    ...
    // BUG. See screenshots in docs folder
...
void ScoreCard::printFinalSC(string name){
    ...
    upScore = upScore >= 20 ? (upScore+bonus) : upScore;
    upSum = upScore;
    
    cout << "\n\t" << name << "'s Scorecard\n";
    printScoreCard();
    cout << endl;    
    cout << setw(5) << " "  << left << setw(20) << "| Upper Score" << " | " << right << setw(6) << upScore << " |\n";
    cout << setw(5) << " "  << left << setw(20) << "| Bonus"       << " | " << right << setw(6) << bonus << " |\n";
    cout << setw(5) << " "  << "-------------------------------\n";
    cout << setw(5) << " "  << left << setw(20) << "| Upper Total" << " | " << right << setw(6) << upSum << " |\n";
    cout << setw(5) << " "  << left << setw(20) << "| Lower Total" << " | " << right << setw(6) << lowSum << " |\n";
    cout << setw(5) << " "  << "-------------------------------\n";
    cout << setw(31) << "Total Score: " << setw(3) << upSum + lowSum << "\n";
}
