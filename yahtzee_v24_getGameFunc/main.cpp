 ...
 * 
 *  NOTE: WHEN FIRST RUNNING THIS CODE, SELECT 5 FROM MENU, SO IT RESETS THE
 ...
 * Created an array of players inside of Yahtzee's default constructor 
 ...
 v24:
 * Separated play() by creating getGame() to handle the number of rounds loop
...
Yahtzee To Do: 
 * BUG1 Full house not adding points correctly. See screenshots.
   Look at clearance in ish_v4.3
 ...
 * Simplify getRules() 
 * Add upper sum, upper bonus and lower sum to printScoreCard();
