 ...
 * Purpose:  yahtzee group project-_adminClass v1
 *           Is based off userClass_v7
 * 
 * v1:    Is based off userClass_v7.
 ...
 *      * In main() asked Admin to login and then checked if their input matched
 *        the values in the Admin.dat file. 
