...
Yahtzee.prototype.printPlayMenu = function () {
    ...
    string += '<button type="submit" id="choiceButton">Enter</button>'; //onclick="choiceOnClick()"
    msgDiv.innerHTML = string;
    document.getElementById("choiceButton").addEventListener("click", this.choiceOnClick);
};
...
Yahtzee.prototype.startGame = function (user) {
    ...
    this.checkNPlayer(name);// if more than 1 player, then print welcome message 
...
Yahtzee.prototype.checkNPlayer = function (name) {
