...
ScoreCard.prototype.recordScore = function (category, score) {
    ...
    // if it's not last round, then set scores array in for possible scorecard points
...
ScoreCard.prototype.printFinalSC = function (name) {
    ...
    var bonusMin = 63;
    var bonus = (this.getRound()===13 && this.getUpperScore() >= bonusMin) ? 25 : 0;
