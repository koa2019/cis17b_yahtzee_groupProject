...
Admin::~Admin(){
    cout<<"\nHit Admin Destructor(). Static class, so nothing to destroy.\n";
}
...
void Admin::signUp(){    
    ...
    char ans='n';
    int count=0;  
    int recrdCnt = Admin::getTtlRec();  // Gets the total # of profiles created.
...
void Admin::wrtTxt(const char ch){
...
void Admin::wrtBin(const char ch){
