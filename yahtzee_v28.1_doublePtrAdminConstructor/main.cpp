 ...
 * 
 v28.2:
 * dont read binary in findBy functions. have them compare usrArr
 * 
 * 
 Admin/User To Do:  
 ...
 *Destroy **player in Yahtzee
 ...
 Ask Lehr:
 * Admin admin3; vs using this from main()
            ...
            {       
                ...
                if(admin.isUsrLogin()){
                    ...
                    if(game1.startGame(user2)) {                         
                        ...
                        cout << "\nReading binary....";
                        admin.findByIndx(user2.getNumRec());
                        admin.printAdUsr();   
                    }                                                    
                }
                break;
