 ...
 * Purpose:  yahtzee group project- Admin class v10.
 *           Is an exact copy of yahtzee_v7_userClass_whileLoop.
 * 
 ...
 * 
 * v10: Needs to Removes adding multiple Users.
 * 
 * To do:
...
int main(int argc, char** argv) {
    ...
    /*********   READ BINARY FILE & RETURN 1 RECORD   ********/
    int oneRec = 5; //(rand()%(0+7)); // As of now there's 8 records in data.txt
