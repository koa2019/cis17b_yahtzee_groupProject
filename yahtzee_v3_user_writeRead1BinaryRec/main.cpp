 ...
 * Purpose:  yahtzee group project-userLogin v3
 * 
 ...
 * 
 * To do:
 *       change password minSize to 7 char
 */
...
int main(int argc, char** argv) {
    ...
    cout<<endl<<endl<<"Reading first record in binary file.\n\n";
    ...
    // read in the string's size and then read in the actual string
    unsigned short sz = 0;
    inBin.read(reinterpret_cast<char *>(&sz), sizeof(sz) ); // write the size of this string to binary file    
    string nme = "";
    nme.resize(sz);  // resize string to this size
    cout<<"nme size = " << nme.size()<<endl;    
    ...
    inBin.read(reinterpret_cast<char *>(&sz), sizeof(sz) ); // write the size of this string to binary file
    string emai = "";
    emai.resize(sz);  // resize string to this size
    cout<<"emai size = " << emai.size()<<endl;    
    ...
    inBin.read(reinterpret_cast<char *>(&sz), sizeof(sz) ); // write the size of this string to binary file
    string pwd = "";
    pwd.resize(sz);  // resize string to this size
